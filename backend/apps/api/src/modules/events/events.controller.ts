...
export class EventsController {
	...
	async updateEvent(
		...
		if (
			...
			body.priorityListDeadline !== event.priorityListDeadline?.toISOString()
		) {
			throw new BadRequestException("Cannot modify priority list deadline: the event is finished");
		}
