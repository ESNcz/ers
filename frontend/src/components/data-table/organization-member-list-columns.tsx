...
export const organizationMemberFacetedFilters: DataTableFacetedFilterConfig[] = [
  {
    ...
    title: "Gender",
    options: [
      { label: "Male", value: "male", icon: IconCheck },
      { label: "Female", value: "female", icon: IconX },
    ],
  },
];
...
export const OrganizationMemberListColumns = (
  ...
  createColumns<OrganizationMember>([
    ...
    },
    {
      ...
      enableSorting: false,
      enableGlobalFilter: true,
      render: (member) => <Text>{member.user.gender}</Text>,
    },
    {
      id: "email",
      header: "E-mail",
    ...
    },
    {
      ...
      enableSorting: false,
      enableGlobalFilter: true,
      render: (member) => <Text>{member.user.role?.name ?? "N/A"}</Text>,
    },
    {
      id: "operations",
      header: "Operations",
      ...
      render: (member) => {
        ...
        return (
          <Flex justify="space-evenly" gap={16}>
            ...
            <Tooltip label={member.user.id === currentUserId ? "You cannot remove yourself" : "Remove from Organization"}>
              <ActionIcon
                variant="subtle"
                size={48}
                color="red"
