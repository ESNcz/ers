 ...
 */
export const sendSpotNotifications = (
  id: number,
  options?: SecondParameter<typeof customInstance>,
  signal?: AbortSignal,
) => {
  return customInstance<SpotNotificationResponseDto | void>(
    { url: `/events/${id}/spot-notifications`, method: "POST", signal },
    options,
  );
};

export const getSendSpotNotificationsMutationOptions = <TError = ErrorType<void>, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<Awaited<ReturnType<typeof sendSpotNotifications>>, TError, { id: number }, TContext>;
  request?: SecondParameter<typeof customInstance>;
}): UseMutationOptions<Awaited<ReturnType<typeof sendSpotNotifications>>, TError, { id: number }, TContext> => {
  const mutationKey = ["sendSpotNotifications"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && "mutationKey" in options.mutation && options.mutation.mutationKey
      ? options
      : { ...options, mutation: { ...options.mutation, mutationKey } }
  ...
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof sendSpotNotifications>>, { id: number }> = (props) => {
    const { id } = props ?? {};

    return sendSpotNotifications(id, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type SendSpotNotificationsMutationResult = NonNullable<Awaited<ReturnType<typeof sendSpotNotifications>>>;

export type SendSpotNotificationsMutationError = ErrorType<void>;

export const useSendSpotNotifications = <TError = ErrorType<void>, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<Awaited<ReturnType<typeof sendSpotNotifications>>, TError, { id: number }, TContext>;
    request?: SecondParameter<typeof customInstance>;
  },
  queryClient?: QueryClient,
): UseMutationResult<Awaited<ReturnType<typeof sendSpotNotifications>>, TError, { id: number }, TContext> => {
  const mutationOptions = getSendSpotNotificationsMutationOptions(options);
...
export const createJoinRequest = (
  ...
  return customInstance<OrganizationJoinRequest>(
    { url: `/organization/${id}/join-requests`, method: "POST", signal },
    options,
  );
};

export const getCreateJoinRequestMutationOptions = <TError = ErrorType<void>, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<Awaited<ReturnType<typeof createJoinRequest>>, TError, { id: string }, TContext>;
  request?: SecondParameter<typeof customInstance>;
}): UseMutationOptions<Awaited<ReturnType<typeof createJoinRequest>>, TError, { id: string }, TContext> => {
  ...
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof createJoinRequest>>, { id: string }> = (props) => {
    const { id } = props ?? {};

    return createJoinRequest(id, requestOptions);
  };
...
export const useCreateJoinRequest = <TError = ErrorType<void>, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<Awaited<ReturnType<typeof createJoinRequest>>, TError, { id: string }, TContext>;
    request?: SecondParameter<typeof customInstance>;
  },
  queryClient?: QueryClient,
): UseMutationResult<Awaited<ReturnType<typeof createJoinRequest>>, TError, { id: string }, TContext> => {
  const mutationOptions = getCreateJoinRequestMutationOptions(options);
 ...
 */
export const getOrganizationJoinRequests = (
  id: string,
  options?: SecondParameter<typeof customInstance>,
  signal?: AbortSignal,
) => {
  return customInstance<OrganizationJoinRequest[]>(
    { url: `/organization/${id}/join-requests`, method: "GET", signal },
    options,
  );
};

export const getGetOrganizationJoinRequestsQueryKey = (id?: string) => {
  return [`/organization/${id}/join-requests`] as const;
};

export const getGetOrganizationJoinRequestsQueryOptions = <
  TData = Awaited<ReturnType<typeof getOrganizationJoinRequests>>,
  TError = ErrorType<void>,
>(
  id: string,
  options?: {
    query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getOrganizationJoinRequests>>, TError, TData>>;
    request?: SecondParameter<typeof customInstance>;
  },
) => {
  const { query: queryOptions, request: requestOptions } = options ?? {};

  const queryKey = queryOptions?.queryKey ?? getGetOrganizationJoinRequestsQueryKey(id);

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getOrganizationJoinRequests>>> = ({ signal }) =>
    getOrganizationJoinRequests(id, requestOptions, signal);

  return { queryKey, queryFn, enabled: !!id, ...queryOptions } as UseQueryOptions<
    Awaited<ReturnType<typeof getOrganizationJoinRequests>>,
    TError,
    TData
  > & { queryKey: DataTag<QueryKey, TData, TError> };
};

export type GetOrganizationJoinRequestsQueryResult = NonNullable<
  Awaited<ReturnType<typeof getOrganizationJoinRequests>>
>;
export type GetOrganizationJoinRequestsQueryError = ErrorType<void>;

export function useGetOrganizationJoinRequests<
  TData = Awaited<ReturnType<typeof getOrganizationJoinRequests>>,
  TError = ErrorType<void>,
>(
  id: string,
...
>(
  ...
  const queryOptions = getGetOrganizationJoinRequestsQueryOptions(id, options);
...
export const respondToJoinRequest = (
  ...
  return customInstance<OrganizationJoinRequest>(
    {
      url: `/organization/join-requests/${requestId}`,
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
...
export const getRespondToJoinRequestMutationOptions = <TError = ErrorType<void>, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof respondToJoinRequest>>,
    TError,
    { requestId: number; data: RespondJoinRequest },
    TContext
  >;
  request?: SecondParameter<typeof customInstance>;
}): UseMutationOptions<
...
> => {
  ...
  > = (props) => {
    ...
    return respondToJoinRequest(requestId, data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type RespondToJoinRequestMutationResult = NonNullable<Awaited<ReturnType<typeof respondToJoinRequest>>>;
export type RespondToJoinRequestMutationBody = RespondJoinRequest;
export type RespondToJoinRequestMutationError = ErrorType<void>;

export const useRespondToJoinRequest = <TError = ErrorType<void>, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof respondToJoinRequest>>,
      TError,
  ...
  TContext
> => {
  const mutationOptions = getRespondToJoinRequestMutationOptions(options);
 ...
 */
export const getMyJoinRequests = (options?: SecondParameter<typeof customInstance>, signal?: AbortSignal) => {
  return customInstance<OrganizationJoinRequest[]>({ url: `/users/me/join-requests`, method: "GET", signal }, options);
};

export const getGetMyJoinRequestsQueryKey = () => {
  return [`/users/me/join-requests`] as const;
};

export const getGetMyJoinRequestsQueryOptions = <
  TData = Awaited<ReturnType<typeof getMyJoinRequests>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getMyJoinRequests>>, TError, TData>>;
  request?: SecondParameter<typeof customInstance>;
}) => {
  const { query: queryOptions, request: requestOptions } = options ?? {};

  const queryKey = queryOptions?.queryKey ?? getGetMyJoinRequestsQueryKey();

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getMyJoinRequests>>> = ({ signal }) =>
    getMyJoinRequests(requestOptions, signal);

  return { queryKey, queryFn, ...queryOptions } as UseQueryOptions<
    Awaited<ReturnType<typeof getMyJoinRequests>>,
    TError,
    TData
  > & { queryKey: DataTag<QueryKey, TData, TError> };
};

export type GetMyJoinRequestsQueryResult = NonNullable<Awaited<ReturnType<typeof getMyJoinRequests>>>;
export type GetMyJoinRequestsQueryError = ErrorType<unknown>;
...
>(
  ...
  const queryOptions = getGetMyJoinRequestsQueryOptions(options);
